...
class Exam(models.Model):
    ...
    marks  = models.TextField( verbose_name="Student scores in (CSV) (Header: ROLL NO,Q1,Q2,..,Qk,Comment1,...,Commentk) [ROLL NO contains roll no separated by -]", max_length=100000, null=True, blank=True)
